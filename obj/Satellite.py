...
class Satellite:
    ...
    def __init__(self, scenario: STKObjects, stkRoot) -> None:
    ...
    # turn STKObjects to IAgSatellite objects, Util
    def getSat2(sat):
    ...
    def createSatellite(self, satName: str) -> STKObjects.IAgSatellite:
        ...
        Satellite.setOrbit(Satellite.getSat2(sat))
    ...
    def setOrbit(sat2: STKObjects.IAgSatellite, ele: list = [11, 7000, 0.01, 90, 270, 90, 10] ,propagatorType: int = 7):
